    ...
    <div className="min-h-screen flex items-center justify-center bg-black py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="text-center lg:text-left">
          <h1 className="text-5xl font-bold text-white mb-6">Get Started</h1>
          <p className="text-xl text-gray-300 mb-8">
            Join our platform and experience the Bot to analyze your Sales.
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  autoComplete="name"
                  required
                  className="input-field w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-white placeholder-gray-400 transition-all duration-200"
